...
export const features: Feature[] = [
  ...
  },
  {
    ...
    tagline: "Existing code: requirements → tests → validate. New system: requirements → test cases.",
    icon: "🧪",
    accent: "from-emerald-500 to-teal-600",
    inputLabel: "Requirements & source",
    placeholder: "Paste requirements or upload a file…",
    cta: "Generate tests",
    owner: "Vishal",
  },
  {
